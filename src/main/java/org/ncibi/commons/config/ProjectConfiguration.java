...
public final class ProjectConfiguration
{
    ...
    /**
     * Returns true if the property is overridden by in override configuration file
     * 
     * @param property 
     * 			The property in question 
     * @return true for overridden properties
     */
    public static boolean isProjectPropertyOverridder(String property){
    	String probe = getOverrideProjectProperty(property);
    	return probe != null;
    }
