...
public final class StrUtils
{
    ...
    /**
     * Split on newline separated string.
     */
	public static final Splitter NEWLINE_SPLITTER = Splitter.on('\n').trimResults().omitEmptyStrings();
	
    /**
     * Split on comma or space separated string.
     */
    ...
    public static List<String> splitCommaSeparatedString(String string) {
		...
		return Lists.newArrayList(COMMA_SPLITTER.split(string));
	}
	
	public static List<String> splitSemicolonSeparatedString(String string) {
		if(string == null) return new ArrayList<String>();
		return Lists.newArrayList(SEMI_COLON_SPLITTER.split(string));
	}
    
    public static List<String> splitCommaOrSpaceSeparatedString(String string) {
		if(string == null) return new ArrayList<String>();
		return Lists.newArrayList(COMMA_SPACE_SPLITTER.split(string));
	}
	
	public static List<String> splitNewlineSeparatedString(String string) {
		if(string == null) return new ArrayList<String>();
		return Lists.newArrayList(NEWLINE_SPLITTER.split(string));
	}
